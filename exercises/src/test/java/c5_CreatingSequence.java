...
public class c5_CreatingSequence {
    ...
    public void runnable_counter() {
        ...
        Mono<Void> runnableMono = Mono.fromRunnable(runnable); //todo: change this line only
    ...
    public void repeat() {
        ...
        Flux<Integer> repeated = Mono.fromCallable(counter::incrementAndGet).repeat(9); //todo: change this line only
